...
const navigationItemClass = () => 'font-head text-xl tracking-widest text-white'

export const NavigationBar = (props: any) => {
  return <>
    <div className="fixed space-x-5 flex flex-row rounded-full gap-16 top-5 left-10 right-10 bg-gray-500 bg-opacity-5 backdrop-blur-lg items-center px-10 py-4 z-50">
        <LayeredTitleEffect/>
...
const LayeredTitleEffect = (props: any) => {
  return <div className="text-3xl font-bold text-black flex flex-row h-full">
      <div className="w-20 overflow-visible flex flex-row">
        <span className="text-white font-head text-4xl tracking-widest">DEVLOGS</span>
