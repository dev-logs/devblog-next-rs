...
export const NavigationBar = (props: any) => {
    return <>
        <div
            className="fixed md:space-x-5 flex flex-row px-2 md:rounded-full md:gap-16 gap-2 top-5 md:left-10 left-2 md:right-10 right-2 bg-gray-500 bg-opacity-5 backdrop-blur-lg items-center md:px-10 py-4 z-50">
            <LayeredTitleEffect/>
    ...
    return <div className="md:text-3xl font-bold text-black flex flex-row h-full">
        <div className="w-20 overflow-visible flex flex-row">
            ...
            <div className="rotate-90 scale-75 -translate-x-3 -translate-y-1">
                <span className="text-white font-head text-sm tracking-widest md:rounded-full px-2 py-1">studio</span>
            </div>
        </div>
