...
export const DiscussionInput = () => {
    return (
        <div className="bg-black border border-blue-500 rounded-md p-4 mb-4">
            <div contentEditable="true" className="w-full h-full min-h-[60px] mb-2 outline-none">
                <p>Hi <a className="text-blue-500">@Jo</a></p>
            </div>
            <div className="flex justify-between items-center border-t border-gray-600 pt-5">
                ...
                <div className="flex items-center space-x-4">
                    ...
                    <button className="btn primary bg-blue-500 text-white px-4 py-2 rounded-md">Send</button>
                </div>
            </div>
        </div>
    );
