...
const DevlogStudio = (props: any) => {
  return <div className={`-mr-4 bg-opacity-0 flex flex-row items-center text-white font-roboto md:text-4xl text-xl font-extrabold uppercase whitespace-nowrap ${props.className}`}>
