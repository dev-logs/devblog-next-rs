...
export const ClassicPostItemContainer = (props: PostItemProps) => {
    ...
    return <div className="col-span-1">
        <div
            className="flex flex-col md:space-y-3 bg-black rounded-xl md:justify-between overflow-clip p-5 md:min-h-[500px]">
            <div className="flex md:flex-col flex-row">
                <img
                    className="aspect-auto md:w-full object-contain bg-gray-400 bg-opacity-10 rounded-xl md:h-auto md:rounded-t-xl w-[30vw]"
                    src={post.publicImage}/>
                <div className="flex flex-col mt-2 md:mt-5 ga-2 md:gap-5 mx-5 flex-1">
                    <span
                        className="font-roboto md:font-bold uppercase text-white text-lg md:text-2xl">{post.title}</span>
                    <span
