  ...
  return (
    <>
      <div className="relative flex flex-col h-full w-full">
        ...
        <div className="container mt-2 md:mt-20 bg-zinc-900 md:gap-5 flex flex-col w-full justify-center items-center rounded-2xl bg-opacity-90 h-min z-10 gap-7">
    ...
    <>
      <div id={"blogs"} className="flex w-full flex-col text-white">
        ...
        <div className="container flex flex-row md:mt-52 mt-20 items-start w-[95%] h-full">
            <div className="-rotate-90 md:-translate-x-32 -translate-x-10 mt-16 lg:-mr-52 md:-mr-48 -mr-16 border-b-4 pb-1 border-yellow-500 md:w-[330px] w-[120px]">
