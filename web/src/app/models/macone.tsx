...
export const MacOne = forwardRef((props: any, ref) => {
    ...
    const model = useGLTF(`${process.env.NEXT_PUBLIC_PATH_PREFIX}3d-models/macone/geometries2.glb`)
    const helloWorldLCD = useTexture(`${process.env.NEXT_PUBLIC_PATH_PREFIX}images/hello-world-lcd.jpg`)
...
useGLTF.preload(`${process.env.NEXT_PUBLIC_PATH_PREFIX}3d-models/macone/geometries2.glb`)
useTexture.preload(`${process.env.NEXT_PUBLIC_PATH_PREFIX}images/hello-world-lcd.jpg`)
