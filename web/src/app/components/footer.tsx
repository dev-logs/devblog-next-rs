  ...
  return (
    <>
      ...
      >
        ...
        <div className="flex md:flex-row flex-col md:gap-5 w-full justify-between items-center h-full mt-[7vh] md:px-16 bg-white z-20 max-h-[80px]">
          <div className="flex flex-row items-center md:gap-5 gap-1 md:text-xl justify-between">
            <a
              href="devlogstudio@gmail.com"
              className="font-roboto md:text-xl text-black text-sm underline"
            >
          ...
          <span className="font-roboto text-black md:text-xl">
